 ...
 */
@Schema(description = "Payload for creating a financial transaction")
public record CreateTransactionRequest(
        @Schema(description = "UUID of the category (system or user-owned)", example = "3fa85f64-5717-4562-b3fc-2c963f66afa6")
        @NotNull(message = "Category ID is required")
        UUID categoryId,

        @Schema(description = "Monetary amount (must be positive)", example = "1250.50")
        ...
        @Schema(description = "Optional transaction description or notes", example = "Grocery shopping at supermarket")
